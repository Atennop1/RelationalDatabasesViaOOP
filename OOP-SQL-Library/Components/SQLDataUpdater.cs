...
namespace LibrarySQL
{
    public sealed class SQLDataUpdater : ISQLDataUpdater
    {
        ...
        public void UpdateData(string databaseName, ISQLArgument[] argumentsThatChanging, ISQLArgument[] argumentsByWhichChanging = null!)
        {
            ...
            if (argumentsByWhichChanging != null && argumentsThatChanging.Length != 0)
            {
